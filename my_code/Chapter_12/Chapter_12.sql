...
TO 'C:\Users\vumat\Desktop\CodeCollege\SQL\my_code\Courses and students.txt'
WITH (FORMAT CSV, HEADER);
...
UPDATE students2
SET phone_number = '071-123-4567'
WHERE student_name = 'Alice Johnson';

UPDATE students2
SET phone_number = '072-234-5678'
WHERE student_name = 'Bob Smith';

UPDATE students2
SET phone_number = '073-345-6789'
WHERE student_name = 'Charlie Brown';

-- Activate the 'History' course
UPDATE courses
SET is_active = TRUE
